...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ListSpotViewHolder> {
    ...
    public SearchAdapter(Context context, List<Spot> listSpot, DBHelper dbHelper) {
